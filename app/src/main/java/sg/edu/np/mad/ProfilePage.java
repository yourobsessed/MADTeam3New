        ...
        editpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(oldp)) {
                    Toast.makeText(ProfilePage.this, "Current Password cant be empty", Toast.LENGTH_LONG).show();
                    return;
                }
                if (TextUtils.isEmpty(newp)) {
                    Toast.makeText(ProfilePage.this, "New Password cant be empty", Toast.LENGTH_LONG).show();
                    return;
                }
                dialog.dismiss();
        ...
        databaseReference.child("Accounts").child(DataHolder.username).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (query) {
                    ...
                    Toast.makeText(ProfilePage.this, "Changed Password", Toast.LENGTH_LONG).show();
                }
                else {
                    Toast.makeText(ProfilePage.this, "Old Password Wrong", Toast.LENGTH_LONG).show();
                }
            }
            @Override
        ...
        editusername.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(newuname)) {
                    Toast.makeText(ProfilePage.this, "New Username cant be empty", Toast.LENGTH_LONG).show();
                    return;
                }
                dialog.dismiss();
        ...
        databaseReference.child("Accounts").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!query) {
                    ...
                    Toast.makeText(ProfilePage.this, "Username already exists", Toast.LENGTH_LONG).show();
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
