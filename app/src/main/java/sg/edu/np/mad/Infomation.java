...
public class Infomation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.nav_HomeButton){
            ...
            Intent newIntent = new Intent(Infomation.this, HomePage.class);
            startActivity(newIntent);

        }
        else if (menuItem.getItemId() == R.id.nav_foodbank){
            //Log.i(title, "FoodBank pressed");
            Intent newIntent = new Intent(Infomation.this, GeneralViewPage.class);
            startActivity(newIntent);
        }
        else if (menuItem.getItemId() == R.id.nav_NotificationButton) {
            Intent toNotificationpage = new Intent(Infomation.this, NotificationViewPage.class);
            startActivity(toNotificationpage);

        } else if (menuItem.getItemId() == R.id.nav_WishlistButton) {
            Intent toWishlistpage = new Intent(Infomation.this, WishlistPage.class);
            startActivity(toWishlistpage);

        } else if (menuItem.getItemId() == R.id.nav_reviewButton) {
            Intent toReviewPage = new Intent(Infomation.this, ReviewPage.class);
            startActivity(toReviewPage);

        } else if (menuItem.getItemId() == R.id.nav_directionButton) {
            Intent todirectionPage = new Intent(Infomation.this, Direction.class);
            startActivity(todirectionPage);

        } else if (menuItem.getItemId() == R.id.nav_profileButton) {
            Intent toProfilePage = new Intent(Infomation.this, Profile.class);
            startActivity(toProfilePage);

        } else if (menuItem.getItemId() == R.id.nav_aboutusbutton) {
            Intent toAboutUs = new Intent(Infomation.this, Infomation.class);
            startActivity(toAboutUs);

        } else if (menuItem.getItemId() == R.id.nav_feedbackbutton) {
            Intent toFeedbackPage = new Intent(Infomation.this, Feedback.class);
